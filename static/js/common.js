...
$(function(){
    ...
    var skywindow = $('.skywindow');
    skywindow.bind('load',function(){
        var contentWindow = skywindow[0].contentWindow;
        skywindow.width(contentWindow.document.body.scrollWidth);
        skywindow.height(contentWindow.document.body.scrollHeight);
    });
});